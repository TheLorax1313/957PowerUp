...
public class DataControlSubsystem {
	...
	public DataControlSubsystem(){
		...
		autoModes.addObject("Cross Auto Line", 1);
		autoModes.addObject("Scale Cross: Right Start", 2);
		autoModes.addObject("Scale Cross: Left Start", 4);
		autoModes.addObject("Slam Scale Right", 3);
		autoModes.addObject("Slam Scale Left", 5);
